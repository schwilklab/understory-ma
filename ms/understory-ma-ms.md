...
[DWS: Josh, Your references table in the repo does not have the full references. Please solve this and make sure the schwilk.bib file has all references we used.only Zald etal 2008 ref I could find was for overstory only ??. Could not find correct Fule ref, but he has others which should have data].
And a few bibs I want to make sure you checked:

- http://srmjournals.org/doi/abs/10.2111/05-051R2.1
- http://www.sciencedirect.com/science/article/pii/S0378112705004573
