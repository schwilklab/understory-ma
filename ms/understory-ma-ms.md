...
Exotic species richness was higher in thin treatments than in control treatments (Fig 2, adjusted p=0.0001, N=7) and in burning treatments compared to controls (Fig. 3, adjusted p = 0.100, N=6). Although exotic species richness was higher in thinning than in burning treatments for all studies that reported it, this was not significant after Bonferroni correction (p=>0.1, N=4). 

Burning had a variable effect on species richness with increases relative to controls at eastern, but not western sites (significant modifier, p = 0.0021, N=15).

Percent Cover
-------------

Burning decreased percent cover of shrubs compared to controls (Fig. 4, adjusted p=0.0689, N=9). There was no significant difference in shrub percent cover between thin and control treatments (N=10), or between thin and burn treatments (N=8). The effect of thinning varied between eastern and western sites with decreases in total understory cover at eastern but not western sites (modifier p=0.0217, N=8) 

There was no significant difference in exotic percent cover or herbaceous percent cover between any of the treatment groups. However, very few 4 papers reported percent cover data for non-natives (Table 1). 

Discussion
==========

Understory communities response to fire and thinning was highly variable across the included studies and few comparisons had mean differences significantly different from zero (Table 2). The most consistent effect was the increase in exotic species following disturbance (Figs 2 and 3). But there was almost no consistent differences between thinning and burning treatments. We were conservative when reporting our results and when vetting papers for inclusion in our study. It is likely that as the body of data concerning understory species continues to grow, additional trends will emerge. In particular, exotic richness may increase in thinning compared to burns (not significant after Bonferroni correction). 

All thinning treatments resulted in increased species richness and (Table 2). All burning treatments resulted decreased species richness and percent cover, except for burning effects on non-native richness, in which case burning had a significantly positive effect compared with controls (Table 2). Thinning (and burning to some extent) has the negative consequence of enhancing richness and cover of non-native species, which is not a desirable outcome in most management scenarios. Burning reduced shrub cover as compared to the other two treatments and this may or may not be a negative consequence depending on the management objective.

Increase of non-native species due to disturbance is well established as is the intensity of disturbance and amount of increase [@Bartuszevige+Kennedy-2009; @Schwilk+Keeley+etal-2009]. Every paper in this study reported increases in richness and cover for both thin and burn treatments (Table 2). One concern of manipulating systems for conservation outcomes (e.g. fire surrogate treatments) is the risk of favoring exotic species. This is especially true when large-scale manipulations are applied such as in national forests for which follow-up treatment may be unfeasible. Although increases in these studies were not large, they could be biologically significant if they were allowed to increase in forest understory or if they were introduced after the treatment application. However, some forest stands may be at greater risk for establishment of exotic species. For example, exotic species are less likely to establish in the interior of forests, and more likely to establish in areas near other large invasions and human establishments [OTHER CITATIONS, @Bartuszevige+Gorchov+etal-2006]. Thus, an important consideration for treatment application is proximity to the wildland urban interface (WUI).
