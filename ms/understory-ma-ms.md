...
[JOW: Should we make this a table instead? DWS: yes]
...
Burning decreased percent cover of shrubs compared to controls (p=0.0344) (N=9). There was no significant difference in shrub percent cover between thin and control treatments (N=10), or between thin and burn treatments (N=8). Thinning caused total understory percent cover to decrease more in eastern forests than in western forests (p=0.0217). Geographic distribution (East vs West) did not have an impact on any of the other treatment groups.
